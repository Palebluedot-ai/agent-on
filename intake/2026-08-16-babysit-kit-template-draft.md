...
> **去向：landed@v0.14.0** —— 两产物以加强版落位 kit/babysit/（模板扩至 §0–§7，新增 08-17 三卡内容、队列真相源与连锁追平不变量；SETUP 权限最小集扩两条；另增 CONTRIBUTING-CLAUSE.md 与组件 README.md）；落位清单 1–3 完成，第 4 条之归档 = 本标注。
