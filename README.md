...
总目标与边界的唯一权威：[CHARTER.md](CHARTER.md)。版本账本：[CHANGELOG.md](CHANGELOG.md)（git tag 即版本）。**当前推荐 pin：`v0.6.0`。**
...
- **v0.6 ✅**：**`v0.6.0`** 消化攒批（真相面四元组、发布门、并行四型、Dartify 协作/安全；bench 29）。minor，存量 pin 直升。
